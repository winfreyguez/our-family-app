...
function App() {
  ...
  const signUp = async (e) => {
    ...
    if (error) alert(error.message) else alert('Account created! Check email to confirm.')
  }
  ...
  return <div style={{padding:'2rem', textAlign:'center'}}><h1>Hello {user.email} 💕</h1><button onClick={() => supabase.auth.signOut()}>Log Out</button></div>
}
export default App
